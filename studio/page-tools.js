...
export function mountPageTools({host,source,getPage,createCopy,onStatus=()=>{}}){
 ...
 async function run(operation){
  ...
  }catch(error){if(active(token))report('error',`Copy not saved. ${error.message||'The PDF could not be processed.'} Your original is unchanged.`);}
