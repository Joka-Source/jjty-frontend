...
export const JOURNAL_OUTCOMES=Object.freeze(['unknown','none','durable-entry','highlight','underline','strikethrough','note','important','undo','navigation','history','range-start','range-end','reading-target','error']);
