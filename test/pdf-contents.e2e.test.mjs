...
test('real PDF contents navigation keeps marks, returns to reading place and survives reopening',{timeout:90000},async t=>{
 ...
 for(const engine of ['mupdf','pdfjs']){
  ...
  await page.click('#reader-pages-toggle');await page.waitForFunction(()=>document.getElementById('reader-page-browser').open);await page.click('#pdf-contents summary');
